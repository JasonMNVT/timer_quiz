 ...
 */
final class Version20230228130828 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE question ADD CONSTRAINT FK_B6F7494E96F50B47 FOREIGN KEY (id_quiz_user_id) REFERENCES quiz_user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
